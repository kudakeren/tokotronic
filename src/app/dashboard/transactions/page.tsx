    ...
    <DashboardShell title="Riwayat Transaksi">
      <div className="grid gap-6">
        <Card className="glass-card">
          <CardHeader><CardTitle>Listing Gadget saya</CardTitle></CardHeader>
          <CardContent className="grid gap-3">
            {voucherOrders.length === 0 ? (
              <p className="text-sm text-muted-foreground">Belum ada Listing Gadget.</p>
              ...
              <div key={order.id} className="rounded-xl border bg-background p-4">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div className="min-w-0">
                    ...
                    <p className="mt-2 break-all rounded-lg bg-red-500/10 px-3 py-2 font-mono text-sm font-bold text-red-700 dark:text-red-300">Kode: {order.redeemCode}</p>
                  </div>
        ...
        <Card className="glass-card">
          <CardHeader><CardTitle>Semua transaksi gadget</CardTitle></CardHeader>
